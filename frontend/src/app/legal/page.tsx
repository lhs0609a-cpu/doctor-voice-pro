...
export default function LegalPage() {
  ...
  const sections = [
    { id: 'terms' as SectionKey, title: '서비스 이용약관', icon: <FileText className="w-5 h-5" /> },
    { id: 'disclaimer' as SectionKey, title: '면책조항', icon: <Shield className="w-5 h-5" /> },
    { id: 'privacy' as SectionKey, title: '개인정보처리방침', icon: <Lock className="w-5 h-5" /> },
    { id: 'medical' as SectionKey, title: '의료정보 관련 고지', icon: <AlertTriangle className="w-5 h-5" /> },
    { id: 'content' as SectionKey, title: 'AI 생성 콘텐츠 정책', icon: <Scale className="w-5 h-5" /> },
    { id: 'platform' as SectionKey, title: '외부 플랫폼 이용 안내', icon: <Users className="w-5 h-5" /> },
    { id: 'copyright' as SectionKey, title: '저작권 및 지적재산권', icon: <Copyright className="w-5 h-5" /> },
    { id: 'ecommerce' as SectionKey, title: '전자상거래 및 환불 정책', icon: <CreditCard className="w-5 h-5" /> },
    { id: 'defamation' as SectionKey, title: '명예훼손 및 불법콘텐츠', icon: <Ban className="w-5 h-5" /> },
    { id: 'account' as SectionKey, title: '계정 및 보안 정책', icon: <UserX className="w-5 h-5" /> },
    { id: 'thirdparty' as SectionKey, title: '제3자 서비스 및 API', icon: <Server className="w-5 h-5" /> },
    { id: 'international' as SectionKey, title: '국제 이용 및 규제', icon: <Globe className="w-5 h-5" /> },
    { id: 'dispute' as SectionKey, title: '분쟁 해결 및 관할', icon: <Gavel className="w-5 h-5" /> },
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <PageHeader
          title="법적 고지 및 이용약관"
          description="닥터보이스 프로 서비스 이용에 관한 법적 사항"
          actions={
        ...
        {/* 중요 안내 배너 */}
        <div className="mb-6 rounded-xl bg-danger-soft p-4">
          <div className="flex items-start gap-3">
            <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-danger" />
            <div>
              <h2 className="text-sm font-semibold text-danger">중요 법적 고지</h2>
              <p className="mt-1 text-sm text-foreground">
                본 서비스를 이용함으로써 귀하는 아래의 모든 약관 및 정책에 <strong>법적 구속력 있는 동의</strong>를 하는 것입니다.
                서비스 이용 전 모든 내용을 주의 깊게 읽어주시기 바랍니다.
              </p>
              <div className="mt-2 rounded-lg border border-danger/30 p-3">
        ...
        <div className="mt-8 space-y-4">
          <div className="rounded-xl bg-warning-soft p-5">
            <h3 className="mb-3 text-sm font-semibold text-warning">법적 구속력 있는 동의</h3>
          ...
          <div className="surface p-5">
            <h3 className="mb-3 text-sm font-semibold text-foreground">약관 변경 및 통지</h3>
      ...
      <footer className="mt-12 border-t">
        <div className="mx-auto max-w-3xl px-4 py-6">
          <div className="text-center text-sm text-muted-foreground">
            ...
            <p className="mt-1">
              법률 문의: <a href="mailto:legal@platonmarketing.com" className="text-primary hover:underline">legal@platonmarketing.com</a>
            </p>
...
function TermsContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">제1조 (목적)</h3>
      <p>
        본 약관은 플라톤마케팅(이하 "회사")이 제공하는 닥터보이스 프로 서비스(이하 "서비스")의
        이용조건 및 절차, 회사와 이용자의 권리, 의무, 책임사항 및 기타 필요한 사항을 규정함을 목적으로 합니다.
      </p>

      <h3 className="section-title mb-3 mt-6">제2조 (정의)</h3>
      ...
      <h3 className="section-title mb-3 mt-6">제3조 (약관의 효력 및 변경)</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">제4조 (이용계약의 체결)</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">제5조 (서비스의 내용)</h3>
      ...
      <h3 className="section-title mb-3 mt-6">제6조 (이용자의 의무)</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">이용자는 다음 각 호의 행위를 하여서는 안 됩니다:</p>
        <ol className="list-decimal pl-5 space-y-2 text-danger">
      ...
      <h3 className="section-title mb-3 mt-6">제7조 (콘텐츠 사용에 대한 책임)</h3>
      <div className="bg-danger-soft border border-danger/40 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2 text-lg">핵심 책임 조항</p>
        <ol className="list-decimal pl-5 space-y-3 text-danger">
          <li>
      ...
      <h3 className="section-title mb-3 mt-6">제8조 (서비스 이용 제한 및 계약 해지)</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">제9조 (서비스의 변경 및 중단)</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">제10조 (손해배상의 제한)</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <ol className="list-decimal pl-5 space-y-2 text-warning">
      ...
      <h3 className="section-title mb-3 mt-6">제11조 (면책조항)</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">제12조 (보상 및 면책 의무)</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p className="font-bold text-foreground mb-2">이용자의 보상(Indemnification) 의무</p>
...
function DisclaimerContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <div className="bg-danger-soft border border-danger/40 rounded-lg p-4 mb-6">
        <h3 className="text-lg font-bold text-danger mb-2">핵심 면책사항</h3>
      ...
      <h3 className="section-title mb-3">1. AI 생성 콘텐츠 관련 면책</h3>
      ...
      <h3 className="section-title mb-3 mt-6">2. 외부 플랫폼 이용 관련 면책</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">3. 마케팅 콘텐츠 관련 면책</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">4. 리뷰/후기 관련 면책</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">중대한 법적 경고</p>
        <ul className="list-disc pl-5 space-y-2 text-warning">
      ...
      <h3 className="section-title mb-3 mt-6">5. 손해배상 책임의 제한</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 서비스 보증의 부인 (Disclaimer of Warranties)</h3>
      ...
      <h3 className="section-title mb-3 mt-6">7. 제3자 서비스 면책</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">8. 면책 동의</h3>
...
function PrivacyContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 개인정보의 수집 및 이용 목적</h3>
      <table className="w-full border-collapse border my-4">
        <thead>
          <tr className="bg-muted">
            <th className="border px-4 py-2 text-left">수집 목적</th>
            <th className="border px-4 py-2 text-left">수집 항목</th>
            <th className="border px-4 py-2 text-left">보유 기간</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border px-4 py-2">회원 가입 및 관리</td>
            <td className="border px-4 py-2">이메일, 비밀번호, 이름</td>
            <td className="border px-4 py-2">탈퇴 시까지</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">서비스 제공</td>
            <td className="border px-4 py-2">병원명, 전문과목, 연락처</td>
            <td className="border px-4 py-2">탈퇴 시까지</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">결제 처리</td>
            <td className="border px-4 py-2">결제 정보, 거래 기록</td>
            <td className="border px-4 py-2">5년 (전자상거래법)</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">서비스 이용 기록</td>
            <td className="border px-4 py-2">IP, 접속 로그, 이용 기록</td>
            <td className="border px-4 py-2">3개월~1년</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">마케팅 (동의 시)</td>
            <td className="border px-4 py-2">이메일, 연락처</td>
            <td className="border px-4 py-2">동의 철회 시까지</td>
          </tr>
        </tbody>
      </table>

      <h3 className="section-title mb-3 mt-6">2. 개인정보의 제3자 제공</h3>
      ...
      <h3 className="section-title mb-3 mt-6">3. 개인정보의 처리 위탁</h3>
      <table className="w-full border-collapse border my-4">
        <thead>
          <tr className="bg-muted">
        ...
        <tbody>
          <tr>
            ...
            <td className="border px-4 py-2">결제 처리</td>
            <td className="border px-4 py-2">위탁계약 종료 시</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Amazon Web Services</td>
            <td className="border px-4 py-2">데이터 저장 및 처리</td>
            <td className="border px-4 py-2">위탁계약 종료 시</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">OpenAI / Anthropic / Google</td>
            <td className="border px-4 py-2">AI 콘텐츠 생성</td>
            <td className="border px-4 py-2">API 호출 시</td>
          </tr>
        </tbody>
      </table>

      <h3 className="section-title mb-3 mt-6">4. 개인정보의 국외 이전</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="text-accent-foreground">
          본 서비스는 AI 콘텐츠 생성을 위해 해외 서버(미국 등)에 위치한 AI 서비스 제공업체의 API를 이용합니다.
          이 과정에서 이용자가 입력한 정보(키워드, 주제 등)가 해외로 전송될 수 있습니다.
        </p>
        <ul className="list-disc pl-5 mt-2 space-y-1 text-accent-foreground">
          <li>이전 국가: 미국</li>
      ...
      <h3 className="section-title mb-3 mt-6">5. 이용자의 권리</h3>
      <ul className="list-disc pl-5 space-y-2">
        <li>개인정보 열람 요구권</li>
      ...
      <h3 className="section-title mb-3 mt-6">6. 개인정보 자동 수집 장치</h3>
      ...
      <h3 className="section-title mb-3 mt-6">7. 개인정보보호 책임자</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p>성명: [담당자명]</p>
        <p>직책: 개인정보보호 책임자</p>
...
function MedicalContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <div className="bg-warning-soft border-2 border-warning/40 rounded-lg p-4 mb-6">
        <h3 className="text-lg font-bold text-warning mb-2">의료법 관련 중요 고지</h3>
      ...
      <h3 className="section-title mb-3">1. 의료 콘텐츠의 법적 성격</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. 의료광고 관련 법적 요구사항</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">의료법 제56조 (의료광고의 금지 등)</p>
        <p className="text-warning text-sm">의료인, 의료기관이 의료광고를 하는 경우 다음 사항을 준수해야 합니다:</p>
        <ul className="list-disc pl-5 space-y-1 text-warning text-sm mt-2">
        ...
        <p className="mt-3 text-warning font-bold">위반 시: 1년 이하의 징역 또는 1천만원 이하의 벌금</p>
      </div>

      <h3 className="section-title mb-3 mt-6">3. 의료법 제27조 (무면허 의료행위 금지)</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
      ...
      <h3 className="section-title mb-3 mt-6">4. 금지되는 표현 예시</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">다음 표현은 의료광고에서 금지됩니다:</p>
      ...
      <h3 className="section-title mb-3 mt-6">5. 이용자의 의무</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 면책사항</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p>
...
function ContentPolicyContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. AI 생성 콘텐츠의 특성 및 한계</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. AI 생성 콘텐츠 표시 의무</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="text-accent-foreground font-bold">이용자는 AI 생성 콘텐츠를 외부에 게시할 때 다음 사항을 준수해야 합니다:</p>
        <ul className="list-disc pl-5 space-y-1 text-accent-foreground mt-2">
      ...
      <h3 className="section-title mb-3 mt-6">3. 금지되는 콘텐츠</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">다음과 같은 콘텐츠 생성 및 사용은 금지됩니다:</p>
        <ul className="list-disc pl-5 space-y-1 text-danger">
      ...
      <h3 className="section-title mb-3 mt-6">4. 콘텐츠 소유권</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. 콘텐츠 모니터링</h3>
      <p>
      ...
      <h3 className="section-title mb-3 mt-6">6. 이용자 책임</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <ul className="list-disc pl-5 space-y-2 text-danger">
...
function PlatformContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 외부 플랫폼 연동 서비스</h3>
      ...
      <h3 className="section-title mb-3 mt-6">2. 플랫폼 약관 준수 의무</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">중요 법적 고지</p>
        <p className="text-warning">
      ...
      <h3 className="section-title mb-3 mt-6">3. 네이버 플랫폼 이용 시 주의사항</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">4. Meta 플랫폼 (Instagram/Facebook) 이용 시 주의사항</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. 계정 연동 시 주의사항</h3>
      <ol className="list-decimal pl-5 space-y-2">
...
function CopyrightContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 회사의 지적재산권</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. AI 생성 콘텐츠의 저작권</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">저작권 관련 주의사항</p>
        <ul className="list-disc pl-5 space-y-2 text-warning">
      ...
      <h3 className="section-title mb-3 mt-6">3. 이용자 입력 정보의 저작권</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">4. 저작권 침해 신고</h3>
      <p>
      ...
      <h3 className="section-title mb-3 mt-6">5. 상표권</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 부정경쟁방지법 관련</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">금지 행위</p>
        <ul className="list-disc pl-5 space-y-1 text-danger">
        ...
        <p className="mt-3 text-danger">위반 시: 부정경쟁방지법에 따른 민형사상 책임</p>
      </div>
    </div>
  )
}
...
function EcommerceContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 결제 및 요금</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. 구독 서비스 및 자동결제</h3>
      <div className="bg-success-soft border border-success/40 rounded-lg p-4 my-4">
        <p className="font-bold text-success mb-2">자동결제(정기결제) 안내</p>
      ...
      <h4 className="text-md font-bold text-foreground mb-3 mt-4">2-1. 자동결제 동의</h4>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h4 className="text-md font-bold text-foreground mb-3 mt-4">2-2. 결제 금액 변경</h4>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h4 className="text-md font-bold text-foreground mb-3 mt-4">2-3. 결제 실패 시 처리</h4>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h4 className="text-md font-bold text-foreground mb-3 mt-4">2-4. 구독 해지</h4>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="font-bold text-accent-foreground mb-2">간편한 해지 절차</p>
      ...
      <h4 className="text-md font-bold text-foreground mb-3 mt-4">2-5. 무료체험(트라이얼)</h4>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">3. 청약 철회 및 환불</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="font-bold text-accent-foreground mb-2">전자상거래법에 따른 청약 철회</p>
        <ul className="list-disc pl-5 space-y-2 text-accent-foreground">
      ...
      <h3 className="section-title mb-3 mt-6">4. 환불 정책</h3>
      <table className="w-full border-collapse border my-4">
        <thead>
          <tr className="bg-muted">
            <th className="border px-4 py-2 text-left">구분</th>
            <th className="border px-4 py-2 text-left">환불 조건</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border px-4 py-2">서비스 미사용</td>
            <td className="border px-4 py-2">결제 후 7일 이내, 서비스 미사용 시 전액 환불</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">서비스 사용</td>
            <td className="border px-4 py-2">사용 기간/크레딧에 비례하여 환불 (수수료 10% 공제)</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">7일 경과</td>
            <td className="border px-4 py-2">환불 불가 (단, 서비스 장애 등 회사 귀책 사유 시 예외)</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">약관 위반으로 인한 해지</td>
            <td className="border px-4 py-2">환불 불가</td>
          </tr>
        </tbody>
      </table>

      <h3 className="section-title mb-3 mt-6">5. 크레딧 정책</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 세금계산서 및 영수증</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">7. 사업자 정보</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p>상호: 플라톤마케팅</p>
        <p>대표자: [대표자명]</p>
        <p>사업자등록번호: [사업자번호]</p>
...
function DefamationContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 명예훼손 관련 법적 책임</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">형법 및 정보통신망법</p>
        <ul className="list-disc pl-5 space-y-2 text-danger">
      ...
      <h3 className="section-title mb-3 mt-6">2. 허위사실 유포</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">3. 개인정보 침해</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">개인정보보호법 위반</p>
        <ul className="list-disc pl-5 space-y-2 text-warning">
      ...
      <h3 className="section-title mb-3 mt-6">4. 업무방해 및 위계</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. 사기 및 기망</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 신고 및 대응</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p className="font-bold text-foreground mb-2">불법 콘텐츠 신고</p>
        <p className="text-foreground">
...
function AccountContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 계정 생성 및 관리</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. 계정 보안</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">3. 금지되는 계정 행위</h3>
      <div className="bg-danger-soft border border-danger/30 rounded-lg p-4 my-4">
        <ul className="list-disc pl-5 space-y-2 text-danger">
          <li>계정을 타인에게 양도, 판매, 대여하는 행위</li>
      ...
      <h3 className="section-title mb-3 mt-6">4. 계정 정지 및 해지</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. 휴면 계정</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">6. 데이터 백업</h3>
      <div className="bg-warning-soft border border-warning/40 rounded-lg p-4 my-4">
        <p className="font-bold text-warning mb-2">중요 안내</p>
        <p className="text-warning">
...
function ThirdPartyContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 제3자 AI 서비스</h3>
      <p>본 서비스는 다음 제3자 AI 서비스를 이용합니다:</p>
      <table className="w-full border-collapse border my-4">
        <thead>
          <tr className="bg-muted">
            <th className="border px-4 py-2 text-left">서비스</th>
            <th className="border px-4 py-2 text-left">제공사</th>
            <th className="border px-4 py-2 text-left">용도</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border px-4 py-2">GPT API</td>
            <td className="border px-4 py-2">OpenAI (미국)</td>
            <td className="border px-4 py-2">텍스트 생성</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Claude API</td>
            <td className="border px-4 py-2">Anthropic (미국)</td>
            <td className="border px-4 py-2">텍스트 생성</td>
          </tr>
          <tr>
            <td className="border px-4 py-2">Gemini API</td>
            <td className="border px-4 py-2">Google (미국)</td>
            <td className="border px-4 py-2">텍스트 생성</td>
          </tr>
        </tbody>
      </table>

      <h3 className="section-title mb-3 mt-6">2. 제3자 서비스 이용약관</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="text-accent-foreground">
      ...
      <h3 className="section-title mb-3 mt-6">3. 제3자 서비스 관련 면책</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">4. 결제 서비스</h3>
      <ul className="list-disc pl-5 space-y-2">
        <li>결제 처리: 토스페이먼츠</li>
      ...
      <h3 className="section-title mb-3 mt-6">5. 외부 링크</h3>
      <p>
...
function InternationalContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 서비스 제공 지역</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">2. 준거법</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="text-accent-foreground">
      ...
      <h3 className="section-title mb-3 mt-6">3. 수출 규제</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">4. 데이터의 국외 이전</h3>
      <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. GDPR 관련 (EU 이용자)</h3>
      <div className="bg-muted p-4 rounded-lg">
        <p className="text-foreground">
      ...
      <h3 className="section-title mb-3 mt-6">6. 언어</h3>
      <p>
...
function DisputeContent() {
  return (
    <div className="prose prose-sm max-w-none pt-4 text-sm text-foreground">
      <h3 className="section-title mb-3">1. 준거법</h3>
      <p>
        본 약관의 해석 및 적용, 회사와 이용자 간의 분쟁에 대해서는
        <strong>대한민국 법률</strong>이 적용됩니다.
      </p>

      <h3 className="section-title mb-3 mt-6">2. 관할 법원</h3>
      <div className="bg-accent border border-primary/30 rounded-lg p-4 my-4">
        <p className="text-accent-foreground">
      ...
      <h3 className="section-title mb-3 mt-6">3. 집단소송 포기</h3>
      <div className="bg-danger-soft border border-danger/40 rounded-lg p-4 my-4">
        <p className="font-bold text-danger mb-2">중요한 법적 권리 포기</p>
        <p className="text-danger">
      ...
      <h3 className="section-title mb-3 mt-6">4. 분쟁 해결 절차</h3>
      <ol className="list-decimal pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">5. 소멸시효</h3>
      <p>
      ...
      <h3 className="section-title mb-3 mt-6">6. 분쟁 해결 기관</h3>
      <div className="bg-muted p-4 rounded-lg">
        <ul className="list-disc pl-5 space-y-2">
      ...
      <h3 className="section-title mb-3 mt-6">7. 권리의 비포기</h3>
      <p>
        회사가 본 약관의 특정 조항을 집행하지 않더라도, 이는 해당 조항 또는
        다른 조항을 집행할 권리를 포기한 것으로 해석되지 않습니다.
      </p>

      <h3 className="section-title mb-3 mt-6">8. 분리가능성</h3>
      <p>
